        ...
        #endif
    {
        ...
        static Vec4<_T> splat(const _T& value) {
            ...
            const constexpr static auto meta = std::make_tuple(
                FieldFriendlyScope::field_registration(&Vec4<_T>::x, "x"),
                FieldFriendlyScope::field_registration(&Vec4<_T>::y, "y"),
                FieldFriendlyScope::field_registration(&Vec4<_T>::z, "z"),
                FieldFriendlyScope::field_registration(&Vec4<_T>::w, "w")
            );
        #endif
